...
class Lista {
    ...
    public void inserir(Game game, int posicao) {
        //DESLOCA OS ELEMENTOS A PARTIR DA POSICAO PARA A DIREITA
    ...
    public String remover(int posicao) {
        String nome = array[posicao].getNome();

        //DESLOCA OS ELEMENTOS A PARTIR DA POSICAO PARA A ESQUERDA
    ...
    public void imprimir() {
        for (int i = 0; i < n; i++) {
            System.out.println("[" + i + "] => " + array[i].getId() + " ## " + 
                    (array[i].getNome() != null ? array[i].getNome() : " ") + " ## " + 
                    (array[i].getReleaseDate() != null ? array[i].getReleaseDate().getData() : " ") + " ## " + 
                    array[i].getEstimatedOwners() + " ## " + 
                    array[i].getPrice() + " ## " + 
                    array[i].listarArray(array[i].getSupportedLanguages()) + " ## " + 
                    array[i].getMetacriticScore() + " ## " + 
                    array[i].getUserScore() + " ## " + 
                    array[i].getAchievements() + " ## " + 
                    array[i].listarArray(array[i].getPublishers()) + " ## " + 
                    array[i].listarArray(array[i].getDevelopers()) + " ## " + 
                    array[i].listarArray(array[i].getCategories()) + " ## " + 
                    array[i].listarArray(array[i].getGenre()) + " ## " + 
                    array[i].listarArray(array[i].getTags()) + " ##");
        }
    }
}
...
public class PrincipalGame {
    ...
    //ESSA FUNCAO INSERE O JOGO NA LISTA
    public static void inserirTudoLista(int id, Game arrayGames[], Lista lista) {
    ...
    //RECEBE UM COMANDO EXEMPLO: IF 40930 E RETORNA O VALOR DO ID
    ...
    public static void main(String args[]) throws IOException {
        ...
        while (!equals(id, "FIM")) {
            inserirTudoLista(stringParaInteiro(id), arrayGames, lista);
            id = sc.nextLine();
        }
        ...
        for (int i = 0; i < n; i++) {
            ...
            operacao += comando.charAt(1);

            switch (operacao) {
                case "II":
                    lista.inserirInicio(buscarPorId(pegarValorOperacao(comando), arrayGames));
                    break;

                case "IF":
                    lista.inserirFim(buscarPorId(pegarValorOperacao(comando), arrayGames));
                    break;
                ...
                case "R*":
                    System.out.println("(R) "+lista.remover(pegarValorOperacao(comando)));
                    break;

                case "I*":
                    //INDEX 1 = ID DO GAME E INDEX 0 = POSICAO
                    lista.inserir(buscarPorId(pegarValorOperacaoDupla(comando)[1], arrayGames), pegarValorOperacaoDupla(comando)[0]);
                    break;
        ...
        // Game jogoTeste = new Game();
        // jogoTeste.setNome("PucK!");
        // lista.inserirInicio(jogoTeste);
        // lista.imprimir();
        // System.out.println("    (RI) " + lista.removerInicio());
        // lista.imprimir();
        // System.out.println("    (RF) " + lista.removerFim());
        // lista.imprimir();
        // System.out.println("---");
        // System.out.println("    (R) " + lista.remover(1));
        // lista.imprimir();
        // System.out.println("---");
        // System.out.println("    (R) " + lista.remover(0));
        // lista.imprimir();
    }
}
