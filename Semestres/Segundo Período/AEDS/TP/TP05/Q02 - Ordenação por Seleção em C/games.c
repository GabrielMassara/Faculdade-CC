...
int main()
{
    ...
    selecao(listaGamesOrdenada, indexListaGamesOrdenada);
    ...
    // CRIA ARQUIVO DE LOG
    FILE *logFile = fopen("885810_selecao.txt", "w");
    if (logFile != NULL) {
        fprintf(logFile, "885810\t%d\t%d\t%f\n", comparacoes, movimentacoes, tempoExecucao);
        fclose(logFile);
    }
