...
public class CarroService {
	...
	public void makeForm(int tipo, Carro carro, int orderBy) {
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			umCarro += "\t\t\t<td>Qtd Lugares: <input class=\"input--register\" type=\"number\" name=\"qtdLugares\" value=\""+ carro.getQtdLugares() +"\"></td>";
			umCarro += "\t\t</tr>";
			umCarro += "\t\t<tr>";
			umCarro += "\t\t\t<td colspan=\"2\">&nbsp;</td>";
			...
			umCarro += "\t\t\t<td>Qtd Lugares: "+ carro.getQtdLugares() +"</td>";
			umCarro += "\t\t</tr>";
			umCarro += "\t\t<tr>";
			umCarro += "\t\t\t<td colspan=\"3\">&nbsp;</td>";
			umCarro += "\t\t</tr>";
			umCarro += "\t</table>";		
		} else {
		...
		list += "\n<tr><td colspan=\"6\" align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;Relação de Carros</b></font></td></tr>\n" +
        		...
        		"\t<td width=\"100\" align=\"center\"><b>Qtd Lugares</b></td>\n" +
		...
		for (Carro p : carros) {
			...
			list += "\n<tr bgcolor=\""+ bgcolor +"\">\n" + 
            		  ...
            		  "\t<td>" + p.getModelo() + "</td>\n" +
            		  "\t<td>" + p.getMarca() + "</td>\n" +
            		  "\t<td align=\"center\">" + p.getQtdLugares() + "</td>\n" +
            		  ...
            		  "\t<td align=\"center\" valign=\"middle\"><a href=\"javascript:confirmarDeleteCarro('" + p.getID() + "', '" + p.getModelo() + "', '" + p.getMarca() + "');\"><img src=\"/image/delete.png\" width=\"20\" height=\"20\"/></a></td>\n" +
            		  "</tr>\n";
		}
		list += "</table>";		
	...
	public Object insert(Request request, Response response) {
		...
		int qtdLugares = Integer.parseInt(request.queryParams("qtdLugares"));
		
		String resp = "";
		
		Carro carro = new Carro(-1, modelo, marca, qtdLugares);
	...
	public Object update(Request request, Response response) {
        ...
        if (carro != null) {
        	...
        	carro.setQtdLugares(Integer.parseInt(request.queryParams("qtdLugares")));
